...
def evaluate_deeplab(model, val_loader, num_classes=104, visualize=True):
    ...
    with torch.no_grad():
        for i, (images, labels) in enumerate(tqdm(val_loader, desc="Validating")):
            ...
            # Visualization only for first image
...
if __name__ == "__main__":
    ...
    print("Model saved as deeplabv3_resnet101_run1.pth")
    ...
    print("Model saved as unet_model_resnet101_run1.pth")
    ...
    print("Model saved as segformer_model_b2_run1.pth")