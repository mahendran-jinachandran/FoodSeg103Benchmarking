...
def poly_lr_lambda(epoch, EPOCHS = 50, power=0.9):
...
# DeepLabV3
def train_deeplab(num_epochs, model, optimizer, train_loader, scheduler):
...
# U-Net 
def train_unet(num_epochs, model, optimizer, train_loader, scheduler):
...
if __name__ == "__main__":
    ...
    deeplab_total_loss = train_deeplab(EPOCHS, deeplab_model, optimizer, train_dataloader,scheduler)
    ...
    torch.save(deeplab_model.state_dict(), "deeplabv3_resnet101_run3.pth")
    print("Model saved as deeplabv3_resnet101_run3.pth")
    ...
    unet_total_loss = train_unet(EPOCHS, unet_model, optimizer, train_dataloader,scheduler)
    ...
    torch.cuda.empty_cache()
    torch.save(unet_model.state_dict(), "unet_model_resnet101_run3.pth")
    print("Model saved as unet_model_resnet101_run3.pth")
    ...
    torch.cuda.empty_cache()
    torch.save(segformer_model.state_dict(), "segformer_model_b2_run3.pth")
    print("Model saved as segformer_model_b2_run3.pth")